...
int inputArg1, inputArg2, inputArg3;
...
void calculateAndDumpResult()
{
	...
	char file_buffer[100];
        sprintf(file_buffer, "exec-count/%d_%d_%d.txt", inputArg1, inputArg2, inputArg3);
...
//		fclose(f);
		...
		f = fopen("Input/cur_input.txt", "r");
                ...
                fscanf(f, "%d %d %d", &inputArg1, &inputArg2, &inputArg3);

                fclose(f);
		printf("==inputArg1: %d, inputArg2: %d, inputArg3 %d\n",inputArg1, inputArg2, inputArg3);
