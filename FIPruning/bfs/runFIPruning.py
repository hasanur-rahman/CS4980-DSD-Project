...
#log_file.close()
#inputlist=inputArgs.split(" ")
os.system("./graphgen "+ inputArgs)
os.system("lli final_program.ll graph" + inputArgs+".txt")
os.system("rm graph" + inputArgs+".txt " + "final_program.ll")
